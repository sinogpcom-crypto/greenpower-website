...
$xxtea = bc_base::load_app_class('xxtea', 'video');
$token = $_POST['token'];
...
if (!preg_match('/([^a-z_]+)/i',$action) && file_exists(BANGCMS_PATH.'api/video_api/'.$action.'.php')) {
	include BANGCMS_PATH.'api/video_api/'.$action.'.php';
} else {
