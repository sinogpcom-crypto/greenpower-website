...
$LANG['website_manage'] = 'BangCMS - 后台管理中心';
$LANG['lockscreen'] = '锁屏';
$LANG['submit'] = '提 交';
$LANG['yes'] = '是';
$LANG['no'] = '否';
...
$LANG['copyright'] = 'CopyRight 1996-2014 正邦品牌顾问服务集团 <a href="http://www.zhengbang.com.cn" target="_blank">BangCMS TEAM</a> ';
...
$LANG['field_omnipotent_tips'] = " 例如：&lt;input type='text' name='info[voteid]' id='voteid' value='{FIELD_VALUE}' style='50' &gt;
        <br>万能字段用法说明：
        <br>本字段值：{FIELD_VALUE}
        <br>当前模型id：{MODELID}
        <br>当前数据id：{ID}
        <br>自定义函数用法：{FUNC(my_function~~{FIELD_VALUE})}  (my_function函数返回html)";
?>