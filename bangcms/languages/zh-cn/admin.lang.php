...
/*Language Format:
Add a new file(.lang.php) with your module name at /bangcms/languages/
translation save at the array:$LANG
*/

//index
$LANG['admin_site_title'] = 'BangCMS - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['bangcms_title'] = 'BangCMS内容管理系统';
...
$LANG['main_safety_permissions'] = '※ 建议您将BangCMS目录设置为755（linux）或只读（windows）';
...
$LANG['main_product_team'] = 'BangCMS系统开发团队';
...
$LANG['must_be_32_w'] = '为单点登录中该设置的密钥';
...
$LANG['setting_phpsso_type'] = '请填写接口地址，格式为：http[s]://www.bangsso.cn,结尾不包含“/”';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 BangCMS可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
BangCMS可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
//添加测试数据         谢亚南  2015-01-08
$LANG['add_test_data'] ='添加测试数据';
$LANG['add_test_data_failure'] ='测试数据添加失败';
$LANG['add_test_data_success'] ='测试数据添加成功';
$LANG['add_single_failure'] ='单网页数据添加失败';
$LANG['add_single_success'] ='单网页数据添加成功，请更新栏目页';
$LANG['add_test_data_success_5'] ='成功添加5条测试数据';
$LANG['page_existing_data'] ='该单网页存在数据';
//end
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http[s]://www.zhengbang.com.cn/';
$LANG['domain_end_string'] = '格式应该为http[s]://www.zhengbang.com.cn/，请以‘/’结束';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http[s]://www.zhengbang.com.cn/';
$LANG['site_domain_ex2'] = '格式应该为http[s]://www.zhengbang.com.cn/，请以‘/’结束';
...
$LANG['setting_connect_notice'] = '如配置为空则前台不显示该第三方登录';
$LANG['connect_enable'] = '是否开启外部通行证';
$LANG['connect_enable_notice'] = '如关闭，前台不显示所有第三方登录';
$LANG['setting_connect'] = '第三方登录';
$LANG['setting_connect_enable'] = '开启第三方登录';
...
$LANG['copyfrom_url_tips'] = '请以http[s]://开头';
