...
class update {
	...
	function __construct() {
		$this->update_url = 'http://update.v9.zhengbang.com.cn/index.php';
		$this->http = bc_base::load_sys_class('http','',1);
	...
	function module($type = '') {
		$string = '';
		$db = bc_base::load_model('pay_payment_model');
	...
	function check_uuid(){
		$site_db = bc_base::load_model('site_model');
