 ...
 * $Id: video.func.php 152 2014-11-24 01:14:56Z jiaokun $
 * @package libs\functions\autoload\video.func.php
 */
/**
 * 获取点击数量
 * @param $hitsid
...
function get_comments($commentid) {
	...
	$db = bc_base::load_model('comment_model');
...
/**
 * 
 * @return Ambigous <URL, string>|mixed
 */
...
function player_code($id = 'video_player',$channelid,$vid,$width = 622, $height = 460, $style_projectid = '') {
	...
	$playerurl = bc_base::load_config('ku6server', 'player_url').$vid.'/style/'.$style_projectid.'/v.swf';
