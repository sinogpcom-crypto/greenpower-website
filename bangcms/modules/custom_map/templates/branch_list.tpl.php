...
?>
<div class="pad-lr-10">
<form name="searchform" action="?m=custom_map&c=custom_map" method="post" >
...
<form name="myform" action="?m=custom_map&c=custom_map&a=delete" method="post" onsubmit="checkuid();return false;">
<div class="table-list">
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			<th width="10%" align="center"><input type="checkbox" value="" id="check_box" onclick="selectall('id[]');"></th>
			<th width="30%"><?php echo L('name')?></th>
			<th width="10%" align="center"><?php echo L('x')?></th>
...
if(is_array($infos)){
	...
	<tr>
		...
		<td  widht="10%"><?php echo $info['x'];?></td>
		...
		<a href="###" onclick="update(<?php echo $info['id']?>, '<?php echo new_addslashes(new_html_special_chars($info['name']))?>')"
			title="<?php echo L('update')?>"><?php echo L('update_branch')?></a>
		|<a href='?m=custom_map&c=custom_map&a=delete&id=<?php echo $info['id']?>'
