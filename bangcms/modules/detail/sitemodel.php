...
class sitemodel extends admin {
	...
	public function add() {
		if(isset($_POST['dosubmit'])) {
			...
			$cache_api = bc_base::load_app_class('cache_api','admin');
	...
	public function delete() {
		$this->sitemodel_field_db = bc_base::load_model('sitemodel_field_model');
		$modelid = intval($_GET['modelid']);
	...
	public function cache_field($modelid = 0) {
		$this->field_db = bc_base::load_model('sitemodel_field_model');
		$field_array = array();
