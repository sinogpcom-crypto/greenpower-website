...
<input type='hidden' name="n_relation_field" value='<?php echo $relation_field?>'>
<input type='hidden' name="n_pid" value='<?php echo $pid?>'>
...
function change_siteid(siteid) {
		$("#load_catgory").load("?m=content&c=content&a=public_getsite_categorys&siteid="+siteid+"&modelid="+<?php echo $_GET['modelid']; ?>);
		$("#siteid").val(siteid);
}
//移除ID
