...
<form name="myform" id="myform" action="?m=detail&c=content&a=add&<?php echo $relation_par?>" method="post" enctype="multipart/form-data">
<input type="hidden" name="parent_model_id" value="<?php echo $parent_model_id?>" />
<input type="hidden" name="relation_model" value="<?php echo $relation_model?>" />
<input type="hidden" name="relation_field" value="<?php echo $relation_field?>" />
