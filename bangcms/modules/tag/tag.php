...
class tag extends admin {
	...
	public function __construct() {
		$this->db = bc_base::load_model('tag_model');
		$this->dbsource = bc_base::load_model('dbsource_model');
		parent::__construct();
	}
	 ...
	 */
	public function add() {
		bc_base::load_app_func('global', 'dbsource');
		if (isset($_POST['dosubmit'])) {
			...
			$modules = array_merge(array(''=>L('please_select')),bc_base::load_config('modules'));
