...
class template_bak extends admin {
	...
	public function __construct() {
		...
		$this->filepath = BC_PATH.'templates'.DIRECTORY_SEPARATOR.$this->style.DIRECTORY_SEPARATOR.$this->dir.DIRECTORY_SEPARATOR.$this->filename;
		$this->fileid = $this->style.'_'.$this->dir.'_'.$this->filename;
		$this->tpl_edit = bc_base::load_config('system', 'tpl_edit');
		$this->db = bc_base::load_model('template_bak_model');
	}
