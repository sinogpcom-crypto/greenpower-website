...
function pc_tag_class ($module) {
	$filepath = BC_PATH.'modules'.DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR.'classes'.DIRECTORY_SEPARATOR.$module.'_tag.class.php';
	if (file_exists($filepath)) {
		$pc_tag = bc_base::load_app_class($module.'_tag', $module); 
...
function template_url($id) {
	...
	if (!file_exists($filepath)) {
		$datacall = bc_base::load_model('datacall_model');
