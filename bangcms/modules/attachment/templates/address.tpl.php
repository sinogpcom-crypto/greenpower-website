...
<table width="100%"  class="table_form">
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="old_attachment_path" id="old_attachment_path" size="40" value="<?php echo bc_base::load_config('system', 'upload_url')?>" /> <?php echo L('old_attachment_address_msg')?></td>
  </tr>
  <tr>
