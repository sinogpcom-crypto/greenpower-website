...
class comment {
	...
	public function __construct() {
		$this->comment_db = bc_base::load_model('comment_model');
		$this->comment_setting_db = bc_base::load_model('comment_setting_model');
		$this->comment_data_db = bc_base::load_model('comment_data_model');
		$this->comment_table_db = bc_base::load_model('comment_table_model');
		$this->comment_check_db = bc_base::load_model('comment_check_model');
	}
	...
	public function add($commentid, $siteid, $data, $id = '', $title = '', $url = '') {
		...
		$badword = bc_base::load_model('badword_model');
