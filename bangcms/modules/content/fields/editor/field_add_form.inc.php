<table cellpadding="2" cellspacing="1" width="98%">
    ...
    <tr> 
      <td>在后台列表显示</td>
      <td><input type="radio" value="1" name="setting[listshow]" /> 是 <input type="radio" checked="" value="0" name="setting[listshow]" /> 否 </td>
    </tr>
    <tr> 
      <td>作为后台搜索字段</td>
      <td><input type="radio" value="1" name="setting[listfilter]" /> 是 <input type="radio" checked="" value="0" name="setting[listfilter]" /> 否 </td>
    </tr>
</table>