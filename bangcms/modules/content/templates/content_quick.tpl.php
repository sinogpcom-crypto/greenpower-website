...
.showMsg h5{background: #304356 url(<?php echo IMG_PATH?>msg_img2.png) no-repeat 8px 4px; color:#fff; padding-left:35px; height:28px; line-height:27px;*line-height:28px; overflow:hidden; font-size:14px; text-align:left}
