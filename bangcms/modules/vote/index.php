...
class index {
	...
	function __construct() {
		...
		$this->vote = bc_base::load_model('vote_subject_model');//投票标题
		$this->vote_option = bc_base::load_model('vote_option_model');//投票选项
		$this->vote_data = bc_base::load_model('vote_data_model'); //投票统计的数据模型
