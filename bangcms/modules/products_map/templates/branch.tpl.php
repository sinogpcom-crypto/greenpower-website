...
<div class="pad_10">
<form action="?m=products_map&c=image_map&a=<?php echo empty($id)?'add':'update'?>&pid=<?php echo $_GET['pid']?$_GET['pid']:$parentid;?>" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="800">
	...
	<tr>
		...
		<?php }else{?>
		<input type="hidden" name="info[pid]" value="<?php echo $_GET['pid'];?>">
		<?php }?>
