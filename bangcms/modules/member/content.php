...
bc_base::load_app_func('global', 'member');
...
class content extends foreground {
	...
	public function publish() {
		...
		$priv_db = bc_base::load_model('category_priv_model'); //加载栏目权限表数据模型
	...
	public function delete(){
		...
		$check_pushed_db = bc_base::load_model('content_check_model');
	 ...
	 * 用户上传视频: 原代码为上传到ku6，不再使用。另外，禁止用户上传视频，视频通过后台上传
	 */
	public function upload_video() {
	    echo 'upload_video() is invalid, pls upload video via backend.';
	}
}
?>