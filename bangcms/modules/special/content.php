...
class content extends admin {
	...
	public function __construct() {
		parent::__construct();
		$this->db = bc_base::load_model('special_content_model');
		$this->data_db = bc_base::load_model('special_c_data_model');
		$this->type_db = bc_base::load_model('type_model');
	}
	...
	public function delete() {
		...
		$special = bc_base::load_model('special_model');
		$info = $special->get_one(array('id'=>$specialid));
		$special_api = bc_base::load_app_class('special_api', 'special');
