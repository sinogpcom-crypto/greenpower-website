...
<table width="100%" class="table_form ">
	...
	<tr>
     ...
     <!--  产品栏目页 -->
<!-- <?php if (in_array($parentid,array(3))) { ?>
      <tr>
        <th>小图标：</th>
        <td><?php echo form::images('info[ico]', 'ico', $ico, 'content');?></td>
      </tr>

      <tr>
        <th>背景图：</th>
        <td><?php echo form::images('info[beijing]', 'beijing', $beijing, 'content');?></td>
      </tr>
<?php } ?> -->


      <?php if (in_array($catid,array(44,45,193,194))) { ?>
	<tr>
       ...
       <?php } ?>
<!-- 
      <?php if (in_array($catid,array(3))  || in_array($parentid,array(3))) { ?>
			...
			<tr>
				<th><?php echo L('摘要')?>：</th>
				<td>
				<textarea name="info[content]" cols="50" rows="8" id="content"><?php echo $content;?></textarea>
				</td>
			</tr>
			<script type="text/javascript">
