...
include BC_PATH.'modules'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.'header.tpl.php';
?>
...
<?php } ?> -->
<!-- <?php if(bc_base::load_config('system','debug')) {?>
<?php echo L('main_safety_debug')?><br />
<?php } ?> -->
<?php if(!bc_base::load_config('system','errorlog')) {?>
<?php echo L('main_safety_errlog')?><br />
<?php } ?>
	<div class="bk20 hr"><hr /></div>	
<?php if(bc_base::load_config('system','execution_sql')) {?>	
...
<?php } ?>
<?php 
$tpl_edit = bc_base::load_config('system','tpl_edit');
if($tpl_edit=='1') {?>
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>BangCMS <?php echo BC_VERSION?>  Release <?php echo BC_RELEASE?><br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<?php echo L('main_product_site')?><a href="http://builder.netbang.com.cn/" target="_blank">http://builder.netbang.com.cn/</a> <br />
	</div>
</div>
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>BangCMS <?php echo BC_VERSION?>  Release <?php echo BC_RELEASE?> <br />
	<?php echo L('main_license_type')?><br />
	<?php echo L('main_serial_number')?><br />
	</div>
</div>
    <div class="bk10"></div>
</div>
