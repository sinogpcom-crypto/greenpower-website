...
<script type="text/javascript">
  ...
  //全选函数
   function setAll() {
       ...
       var loves = document.getElementsByName("menuid[]");
...
<table width="100%" cellspacing="0">
	<thead>
	<tr>
	<th class="text-l cu-span" style='padding-left:30px;'><span onClick="javascript:setAll();"><?php echo L('selected_all');?></span>/<span onClick="javascript:setNo();"><?php echo L('cancel');?></span></th>
	</tr>
	</thead>
</table>
