...
<div class="pad_10">
<?php if(bc_base::load_config('system','plugin_debug')) { ?>
...
?>   
	...
	<td width="25%"><?php if(!$info[appid] && bc_base::load_config('system','plugin_debug')) { ?><img src="<?php echo IMG_PATH?>admin_img/plugin_debug.png" title="Developing"><?php } ?>
