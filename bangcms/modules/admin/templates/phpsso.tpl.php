...
<script language="javascript" type="text/javascript" src="<?php echo JS_PATH?>jquery.min.js"></script>
		<div id="leftMain">
		<h3 class="f14">单点登录<?php echo L('manage')?></h3>
		<ul>
		<li class="sub_menu">
		...
		<li class="sub_menu">
		<a style="outline: medium none;" hidefocus="true" href="<?php echo $setting['phpsso_api_url']?>/index.php?m=admin&c=login&a=logout&forward=<?php echo urlencode($setting['phpsso_api_url'].'/index.php?m=admin&c=member&a=manage')?>" target="right"><?php echo L('exit')?>单点登录</a>
		</li>
		</ul>
		</div>
