...
<input type="hidden" name="tabletype" value="bangcmstables" id="bangcmstables">
...
<?php echo $string;?>
  	...
  	<tr>
	    ...
	    <td colspan=3><input type=text name="email" value="bangcms@zhengbang.com.cn" size="40"></td>
  	</tr>
  	<tr>
