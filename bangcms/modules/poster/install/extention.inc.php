...
$pdb = bc_base::load_model('poster_model');
$sql = "INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 1, 'banner', 1, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/2.png'',\n    ''alt'' => '''',\n  ),\n)', 1285813808, 1446249600, 1285813833, 0, 1, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 2, 'bangcms', 2, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./statics/images/v9/ad_login.jpg'',\n    ''alt'' => ''bangcms专业建站系统'',\n  ),\n)', 1285816298, 1446249600, 1285816310, 0, 1, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 3, 'bangcms下载推荐', 3, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/3.png'',\n    ''alt'' => ''bangcms官方'',\n  ),\n)', 1286504815, 1446249600, 1286504865, 0, 1, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 4, 'bangcms广告', 4, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/4.gif'',\n    ''alt'' => ''bangcms官方'',\n  ),\n)', 1286505141, 1446249600, 1286505178, 0, 0, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 5, 'bangcms下载', 5, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/5.gif'',\n    ''alt'' => ''官方'',\n  ),\n)', 1286509363, 1446249600, 1286509401, 0, 0, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 6, 'bangcms下载推荐1', 6, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/5.gif'',\n    ''alt'' => ''官方'',\n  ),\n)', 1286510183, 1446249600, 1286510227, 0, 0, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 7, 'bangcms下载详情', 7, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/5.gif'',\n    ''alt'' => ''官方'',\n  ),\n)', 1286510314, 1446249600, 1286510341, 0, 0, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 8, 'bangcms下载页', 8, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/1.jpg'',\n    ''alt'' => ''官方站'',\n  ),\n)', 1286522084, 1446249600, 1286522125, 0, 0, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
(1, 9, 'bangcms广告', 9, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/4.gif'',\n    ''alt'' => '''',\n  ),\n)', 1287041759, 1446249600, 1287041804, 0, 0, 0, 0);
INSERT INTO `bangcms_poster` (`siteid`, `id`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES (1, 10, 'bangcms', 10, 'images', 'array (\n  1 => \n  array (\n    ''linkurl'' => ''http://www.zhengbang.com.cn'',\n    ''imageurl'' => ''./uploadfile/poster/6.jpg'',\n    ''alt'' => ''bangcms官方'',\n  ),\n)', 1289270509, 1446249600, 1289270541, 1, 0, 0, 0);";
$sql = str_replace(array("bangcms_", './uploadfile/poster/', './statics/images'), array($pdb->db_tablepre, bc_base::load_config('system','upload_url').'poster/', APP_PATH.'statics/images'), $sql);
