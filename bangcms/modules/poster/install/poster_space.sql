DROP TABLE IF EXISTS `bangcms_poster_space`;
CREATE TABLE IF NOT EXISTS `bangcms_poster_space` (
...
INSERT INTO `bangcms_poster_space` (`siteid`, `spaceid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
