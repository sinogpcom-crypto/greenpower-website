...
'cookie_pre' => 'XkONO_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
'cookie_ttl' => 7200, //Cookie 生命周期，0 表示随浏览器进程
//模板相关配置
...
//附件相关配置
'upload_path' => BANGCMS_PATH.'uploadfile/',
'upload_url' => $path.'uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => $path.'statics/js/',
'css_path' => $path.'statics/css/',
'img_path' => $path.'statics/images/',
'app_path' => $path,//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'LEU5ahNRaCOFIKy1HyfV', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => '',	//接口地址
'phpsso_auth_key' => 'LeOmqEZATeqswqIecxjfkk3V04ZXx_ah', //加密密钥
