...
(function () {
     ...
     */
    // window.UEDITOR_HOME_URL = "/ztcms/statics/js/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
       ...
       // autoFloatEnabled
		...
		,whitList: {
			...
			i:      ['class', 'style'],
			img:    ['src', 'alt', 'title', 'width', 'height', 'id', '_src', 'loadingclass', 'class', 'data-latex','style','_url','anchorname','word_img','style'],
			ins:    ['datetime'],
			li:     ['class', 'style'],
			mark:   [],
			nav:    [],
